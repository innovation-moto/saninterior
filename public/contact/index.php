...
,	'form'			=> 'sfm_form.php' // 入力フォーム用
,	'confirm'		=> 'sfm_confirm.php' // 確認画面用
,	'completion'	=> 'sfm_completion.php' // 送信完了画面
...
function printSubmit($error)
{
	...
	if ($error == 1) {
		// エラーがある場合のHTML出力
		$submit = <<< EOD
<p class="p-contact-section__error">必須項目の入力に不足があります。</p>
<div class="p-contact-section__action">
<div class="c-btn c-btn__bold c-btn__gray">
<button type="button" onclick="history.back()"><span class="text">戻る</span></a>
</div>
</div>
